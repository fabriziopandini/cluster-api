...
const (
	...
	// ClusterTopologyManagedFieldsAnnotation is the annotation used to stores the list of paths managed
	// by the topology controller; changes to those path will be considered autoritative.
	// NOTE: Managed field depends by the last reconciliation of a managed object; this list can
	...
	ClusterTopologyManagedFieldsAnnotation = "topology.cluster.x-k8s.io/managed-fields"
