...
// NOTE: This func assumes the current object is up-to-date; in case the current object has been changed
// for any reason, another reconcile request will be created and the state of the system will reconcile at
// the next reconcile.
