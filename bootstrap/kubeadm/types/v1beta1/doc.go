...
IMPORTANT: Do not change thus files!
IMPORTANT: Those types are meant only for KubeadmConfig serialization/deserialization, and should not be used for other purposes.
*/
